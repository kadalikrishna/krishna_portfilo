    ...
    <section id="about" className="section-offset px-5 py-28 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.8fr_1.2fr]">
        <div>
          ...
          <h2 className="hero-heading text-5xl font-semibold leading-none md:text-7xl">
            {profile.aboutHeading}
          </h2>
        </div>
        <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-8 md:p-10">
          <p className="text-xl leading-9 text-zinc-300 [overflow-wrap:normal] [word-break:normal]">
            {profile.bio}
          </p>
